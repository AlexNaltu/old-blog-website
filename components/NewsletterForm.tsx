...
export default function NewsLetter({}: Props) {
  ...
  return (
    <>
      <div className="w-full p-5 md:p-6 space-y-5 md:max-w-[600px]">
        <div className="newsletter w-fit">
          <h1 className="text-white uppercase font-black w-fit">
        ...
        >
          <Form>
            <div className="flex items-center space-x-2">
              ...
              />
              <button
                className="px-5 py-3 font-bold text-gray-100 transition-all bg-[#ff6100] rounded-md hover:bg-orange-800 hover:scale-105 disabled:opacity-80"
                type="submit"
